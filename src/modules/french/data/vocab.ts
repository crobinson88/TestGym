...
// plus the themed leisure-activities / likes-and-dislikes lesson set. Tests draw
// from this whole pool.
export const VOCAB: VocabWord[] = [...VERBS, ...WORDS, ...WORDS_EXT, ...ACTIVITIES];
